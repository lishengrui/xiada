...
/** PHPLinq */
require_once(dirname(__FILE__) .'/../PHPLinq.php');

/** PHPLinq_ILinqProvider */
require_once(dirname(__FILE__) .'/../PHPLinq/ILinqProvider.php');

/** PHPLinq_Expression */
require_once(dirname(__FILE__) .'/../PHPLinq/Expression.php');

/** PHPLinq_OrderByExpression */
require_once(dirname(__FILE__) .'/../PHPLinq/OrderByExpression.php');

/** PHPLinq_Initiator */
require_once(dirname(__FILE__) .'/../PHPLinq/Initiator.php');
